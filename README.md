...
$ fyc eval examples/eval_stdlib.json --sweep
  ...
  -------------------------------------------------------
  blend a=0             0.61      0.72       0.86   0.682
  blend a=0.25          0.64      0.72       0.86   0.701
  blend a=0.5           0.64      0.78       0.86   0.706
  blend a=0.75          0.69      0.78       0.89   0.747   ← дефолт
  blend a=1             0.61      0.72       0.86   0.681
  semantic              0.61      0.72       0.86   0.681
  lexical               0.39      0.44       0.53   0.431
  rrf                   0.64      0.78       0.86   0.706
```
...
- **гибрид обгоняет обе ветки поодиночке по всем четырём метрикам** — ровно то,
  ради чего он есть;
